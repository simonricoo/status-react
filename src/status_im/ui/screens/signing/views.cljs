...
(defn redeem-tx-header [receiver]
  (fn []
    [react/view {:style {:align-self :stretch :margin-top 30}}
     ...
     [react/view {:style {:flex-direction :row
      ...
      [react/text {:style {:margin-right 32}} (i18n/label :t/account-title)]
      [react/text {:style {:width 128 :margin-right 16} :number-of-lines 1 :ellipsize-mode :middle} receiver]]
     [separator]
