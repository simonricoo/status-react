...
(def rn-iap (oget js-dependencies/react-native-iap "default"))
(def purchase-updated-listener (oget js-dependencies/react-native-iap "purchaseUpdatedListener"))
(def purchase-error-listener (oget js-dependencies/react-native-iap "purchaseErrorListener"))
(def finish-transaction (oget js-dependencies/react-native-iap "finishTransaction"))
