...
in
{
  ...
  "flow-copy-source-^2.0.2" = nodeEnv.buildNodePackage {
    ...
    version = "2.0.7";
    src = fetchurl {
      url = "https://registry.npmjs.org/flow-copy-source/-/flow-copy-source-2.0.7.tgz";
      sha512 = "/9oYivwSRgIyRMWqRkzJgulUCRPqMA8JSt7l0uoW0Xmtp8ItJpURnBczJUvnAKnHp0TNttNILCeuqW2w9cwTFg==";
    };
    dependencies = [
