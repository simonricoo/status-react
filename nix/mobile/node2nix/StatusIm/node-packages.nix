...
let
  sources = {
    ...
    "@types/node-12.0.5" = {
      ...
      version = "12.0.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-12.0.5.tgz";
        sha512 = "CFLSALoE+93+Hcb5pFjp0J1uMrrbLRe+L1+gFwerJ776R3TACSF0kTVRQ7AvRa7aFx70nqYHAc7wQPlt9kY2Mg==";
      };
    };
    "@types/unist-2.0.3" = {
